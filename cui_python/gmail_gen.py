...
def exportprefix(exportdir):
    try:
        ...
        with open(Directory, 'w') as fp:
            ...
            print(
                '\033[32m' + "suffix are exported in selected directory" + '\033[0m')
            input("Press Enter to continue...")
            mainmenu()
    except:
        print(
            '\033[31m' + "Directory not found or no generated suffix found" + '\033[0m')
        input("Press Enter to continue...")
        mainmenu()
...
""" + '\033[0m')
    ...
    if answer == "1":
        email
        genAmount = int(
            input("How many suffix do you want to generate: "))
        emailinput = input(
            "give the gmail acc u wanna use: ")
